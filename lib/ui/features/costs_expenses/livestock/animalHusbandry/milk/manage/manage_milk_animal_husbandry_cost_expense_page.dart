...
import 'package:amca/ui/features/costs_expenses/livestock/animalHusbandry/milk/manage/manage_milk_animal_husbandry_cast_expense_vm.dart';
...
// Method called when initializing the state of the widget.
  ...
  Future<void> createCostAndExpense() async {
    ...
    final costAndExpense = CostAndExpense(
      createDate: date,
      partName: manageVM.animalHusbandry?.farmName,
