...
import 'package:amca/ui/features/costs_expenses/livestock/pigfarmig/manage/manage_meat_pigfarming_cast_expense_vm.dart';
...
// Method called when initializing the state of the widget.
  ...
  Future<void> createCostAndExpense() async {
    ...
    final costAndExpense = CostAndExpense(
      createDate: date,
      partName: manageVM.pigFarming?.farmName,
