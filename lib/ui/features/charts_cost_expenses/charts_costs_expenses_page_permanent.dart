...
class ChartsCostsExpensesPage extends StatefulWidget {
  const ChartsCostsExpensesPage._(
      {super.key, required this.permanentFarmingId});

  static ChangeNotifierProvider<ChartsProfileVM> create({
    Key? key,
    required String permanentFarmingId,
  }) =>
      ChangeNotifierProvider(
        lazy: false,
        create: (context) => ChartsProfileVM()..init(permanentFarmingId),
        child: ChartsCostsExpensesPage._(
          key: key,
          permanentFarmingId: permanentFarmingId,
        ),
      );

  final String permanentFarmingId;
