...
class ChartsCostsExpensesPigPage extends StatefulWidget {
  const ChartsCostsExpensesPigPage._(
      {super.key, required this.pigFarmingId});

  static ChangeNotifierProvider<ChartsProfileVM> create({
    Key? key,
    required String pigFarmingId,
  }) =>
      ChangeNotifierProvider(
        lazy: false,
        create: (context) => ChartsProfileVM()..init(pigFarmingId),
        child: ChartsCostsExpensesPigPage._(
          key: key,
          pigFarmingId: pigFarmingId,
        ),
      );

  final String pigFarmingId;

  @override
  State<ChartsCostsExpensesPigPage> createState() =>
      _ChartsCostsExpensesPigPageState();
}

class _ChartsCostsExpensesPigPageState extends State<ChartsCostsExpensesPigPage> {
  int touchedIndex = -1;
