...
import 'package:amca/ui/features/charts_cost_expenses/animal_husbandry/milk/charts_costs_expenses_page_milk_animal_husbandry.dart';
...
class _ManageMilkAnimalHusbandryState extends State<ManageMilkAnimalHusbandry> {
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute<void>(
                              builder: (BuildContext context) =>
                                  ChartsCostsExpensesMilkAnimalHusbandryPage
                                      .create(
                                animalHusbandryId:
                                    vm.currentAnimalHusbandry!.id!,
                              ),
  ...
  Future<void> createAnimalHusbandry() async {
    final createPermanentVm = Provider.of<CreateAnimalHusbandryVM>(
      context,
      listen: false,
    );
    ...
    final animalHusbandry = MilkAnimalHusbandry(
      ...
      costsAndExpenses:
          createPermanentVm.currentAnimalHusbandry?.costsAndExpenses,
      production: createPermanentVm.currentAnimalHusbandry?.production,
      id: createPermanentVm.isEditMode
          ? createPermanentVm.currentAnimalHusbandry!.id
          : null,
    );
    try {
      await CallsWithDialogs.call(context, () async {
        await createPermanentVm.createAnimalHusbandry(animalHusbandry);
