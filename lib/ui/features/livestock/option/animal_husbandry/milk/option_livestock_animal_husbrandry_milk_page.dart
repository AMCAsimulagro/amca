...
class OptionLivestockAnimalHusbrandryMilkPage extends StatelessWidget {

   /// Constructs an [OptionLivestockAnimalHusbrandryMilkPage] widget.
  const OptionLivestockAnimalHusbrandryMilkPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(AmcaWords.milk),
