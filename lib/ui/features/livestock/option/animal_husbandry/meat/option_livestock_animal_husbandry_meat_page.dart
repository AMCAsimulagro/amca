...
class OptionLivestockAnimalHusbandryMeatPage extends StatelessWidget {

   /// Constructs an [OptionLivestockAnimalHusbandryMeatPage] widget.
  const OptionLivestockAnimalHusbandryMeatPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(AmcaWords.meat),
