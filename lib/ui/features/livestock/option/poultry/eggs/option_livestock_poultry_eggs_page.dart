...
class OptionLivestockPoultryEggsPage extends StatelessWidget {

   /// Constructs an [OptionLivestockPoultryEggsPage] widget.
  const OptionLivestockPoultryEggsPage({super.key});
