...
class OptionLivestockFishFarmingTilapiaPage extends StatelessWidget {

   /// Constructs an [OptionLivestockFishFarmingTilapiaPage] widget.
  const OptionLivestockFishFarmingTilapiaPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(AmcaWords.tilapia),
